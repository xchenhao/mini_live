...
var Chat={
	...
	sendChat: function(){
		...
		if(nickname != undefined){
			html = '<li><span class="system_a">'+nickname+'：</span><span class="system_name">'+chatmsg+'</span></li>';
		}else{
		html = '<li><span class="system_a">消息提示：</span><span class="system_name">'+'登录后才能发言哦'+'</span></li>';
...
/* 连麦 */
var Linkmic={
	linkmic_btn:$("#admin_linkmic"),
	linkmic_out_btn:$("#admin_linkmic_out"),
	playitems:[],
	init: function(){
		this.addEvent();
	},
	addEvent: function(){
		var _this=this;
		_this.linkmic_btn.on("click",function()
		{
			if(_DATA.user==null)
			{
				$('.hd-login .no-login').click();
			...
			if(_DATA.user.id !=_DATA.anchor.id)
			{
				var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"ConnectVideo","action":"1","msgtype":"10","level":"'+_DATA.user.level+'","uname":"'+_DATA.user.user_nicename+'","uid":"'+_DATA.user.id+'","ct":"","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'"}]}';
				Socket.emitData('broadcast',msg);
			}
		})
		
		_this.linkmic_out_btn.on("click",function()
		{
			if(_DATA.user==null)
			{
				$('.hd-login .no-login').click();
			...
			if(_DATA.user.id !=_DATA.anchor.id)
			{
				var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"ConnectVideo","action":"5","msgtype":"10","level":"'+_DATA.user.level+'","uname":"'+_DATA.user.user_nicename+'","uid":"'+_DATA.user.id+'","ct":"","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'"}]}';
				Socket.emitData('broadcast',msg);
			}
		})
	},
	linkmic_allow:function(touid)
	{
		if(_DATA.user &&  _DATA.user.id ==_DATA.anchor.id)
		{
			var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"ConnectVideo","action":"2","msgtype":"10","level":"'+_DATA.user.level+'","uname":"'+_DATA.user.user_nicename+'","uid":"'+_DATA.user.id+'","touid":"'+touid+'",,"playitems":"'+WlTools.jsonTostr(this.playitems)+'","ct":"","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'"}]}';
			Socket.emitData('broadcast',msg);
		}
	},
	linkmic_refuse:function(touid)
	{
		if(_DATA.user &&  _DATA.user.id ==_DATA.anchor.id)
		{
			var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"ConnectVideo","action":"3","msgtype":"10","level":"'+_DATA.user.level+'","uname":"'+_DATA.user.user_nicename+'","uid":"'+_DATA.user.id+'","touid":"'+touid+'","ct":"","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'"}]}';
			Socket.emitData('broadcast',msg);
		}
	},
	
	linkmic_push:function()
	{
		if(_DATA.user && _DATA.user.id !=_DATA.anchor.id)
		{
			var playurl={userid:_DATA.user.id,playurl:'自己的播流地址',pushurl:'0'};
			var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"ConnectVideo","action":"4","msgtype":"10","level":"'+_DATA.user.level+'","uname":"'+_DATA.user.user_nicename+'","uid":"'+_DATA.user.id+'","playurl":"'+playurl+'","ct":"","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'"}]}';
			Socket.emitData('broadcast',msg);
		}
	},                                                                                                                                                                                                        
	...
	linkmic_out:function(touid)
	{
		if(_DATA.user &&  _DATA.user.id ==_DATA.anchor.id)
		{
			var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"ConnectVideo","action":"6","msgtype":"10","level":"'+_DATA.user.level+'","uname":"'+_DATA.user.user_nicename+'","uid":"'+_DATA.user.id+'","touid":"'+touid+'","ct":"","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'"}]}';
			Socket.emitData('broadcast',msg);
		}
	}	
