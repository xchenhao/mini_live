var Login={
					...
					threeWeixin='<div class="weixin js_weixin js_login_weixin"><span></span></div>';
									...
									var		lower_html='</article><article>\
											...
											<article>\
												...
												<p><span class="login-btn fl js-reg">注册</span></p>\
					...
					reg_html='<div class="login_pop js_reg_pop">\
						...
						var signin='</article>\
											...
											<article>\
												...
												<div class="key_con" style="display:none;">\
													<div class="keyBorder">\
														<i class="keyIcon"></i>\
														<input class="key js_reg_code_input" type="text" placeholder="输入验证码" maxlength="6" value="666666">\
													</div>\
													<a class="get_none js_reg_getcode">获取验证码</a>\
												</div>\
												<p><span class="js-login login-btn fl">登录</span></p>\
												<p>注册即表示您同意<em><a style="color: #da5537;" href="./index.php?m=page&a=agreement" target="_blank">《用户协议》</a></em></p>\
												<a class="submit js_reg_submit">确认</a>\
											</article>\
											<p class="other_login_tip"></p>\
					...
					forget_html='<div class="login_pop js_forget_pop">\
											...
											<article>\
												...
												<div class="key_con" style="display:none;">\
													<div class="keyBorder">\
														<i class="keyIcon"></i>\
														<input class="key js_forget_code_input" type="text" placeholder="输入验证码" maxlength="6" value="666666">\
													</div>\
												...
												<a class="submit js_forget_submit">确认</a>\
											</article>\
											<p class="other_login_tip"></p>\
											<div class="login_popbox js_forget_popbox">\
												<div class="inner">\
													...
													<a class="js_forget_captcha">确定</a>\
												</div>\
											</div>',								
	...
	regVerify:function(){
		var _this=this;
		var phone=_this.js_reg_phone_input,pass=_this.js_reg_pass_input,repass=_this.js_reg_repass_input,popbox=_this.js_reg_popbox,reg=_this.js_reg_submit;
		...
		reg.on("click", function(){
			...
			console.log('reg, check pass finish');
			if(!_this.checkPass.test(pass.val())){
				_this.loginWarring("密码必须包含字母和数字，6-12位")
				return false;
			}
			...
			console.log('reg, check repass finish');
			_this.doreg();
		})
	...
	doreg:function(){
		...
		console.log(_this.reg_url, phone, pass, code);
		$.ajax({
			url: _this.reg_url,
